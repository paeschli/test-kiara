...
#define CDR_buffer_data(codec) (codec)->buffer
#define CDR_buffer_size(codec) (codec)->buf_size
#define CDR_buffer_capacity(codec) (codec)->buf_capacity
#define CDR_buffer_position(codec) (codec)->pos

extern CORBA_boolean CDR_buffer_init(CDR_Codec *codec, const size_t size);
extern CORBA_boolean CDR_buffer_ensure_capacity(CDR_Codec *codec, size_t new_capacity);
extern CORBA_boolean CDR_buffer_ensure_capacity_nocopy(CDR_Codec *codec, size_t new_capacity);
extern void CDR_buffer_reset(CDR_Codec *codec);
extern void CDR_buffer_reset_position(CDR_Codec *codec);
...
extern CORBA_boolean CDR_buffer_puts(CDR_Codec *codec, const void *data, const size_t len);
extern CORBA_boolean CDR_buffer_gets(CDR_Codec *codec, void *dest, const size_t len);
...
extern CORBA_boolean CDR_put_seq_begin(CDR_Codec *codec, CORBA_unsigned_long ul);
