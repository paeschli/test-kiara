...
#include "user_types_dds.hpp"
#include <KIARA/kiara.h>
#include <KIARA/kiara_cxx_macros.hpp>

KIARA_CXX_DECL_STRUCT(User::Sequences,
  KIARA_CXX_STRUCT_MEMBER(ls)
  KIARA_CXX_STRUCT_MEMBER(fs)
)
...
namespace User {
    typedef DDS_Float mat44[4][4];
    typedef DDS_Float * FloatPtr;
}
...
KIARA_CXX_DECL_FUNC(Func1,
  KIARA_CXX_FUNC_ARG(DDS_Float *, result)
  KIARA_CXX_FUNC_ARG(DDS_Long, a)
  KIARA_CXX_FUNC_ARG(DDS_Float, b)
